...
from typing import Any, Generic, TypeVar, Type, Callable, ParamSpec
...
class Endpoint(Generic[T, P]):
    ...
    async def request(self, session: ClientSession, headers: dict[str, str], *args: P.args, **kwargs: P.kwargs) -> T:
...
class Client:
    ...
    async def request(self, endpoint: Endpoint[T, P], *args: P.args, **kwargs: P.kwargs):
